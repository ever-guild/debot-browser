...
contract Invoked is Debot {
    ...
    function setSignBoxHandle(uint32 handle) public pure {
        require(handle != 0);
        this.setDataOnchain{
            time: 0, expire: 0, pubkey: 0,
            sign: true, signBoxHandle: handle,
    ...
    function setDataOnchain() public view {
    ...
    function checkArg1(uint128 value) public view {
        require(value == m_arg1, 201);
    }

    function checkArg2(string value) public view {
        require(value == m_arg2, 202);
    }

    function checkArg3(bool value) public view {
        require(value == m_arg3, 203);
    }

    function checkArg4(uint32 index) public view {
        require(index == m_arg4, 204);
    }

    function checkArg5(address value) public view {
        require(value == m_arg5, 205);
    }

    function checkArg6(uint256 value) public view {
